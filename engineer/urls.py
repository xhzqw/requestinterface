...
urlpatterns = [
    ...
    #delete_engineer
    path('delete', views.delete_engineer, name='delete_engineer'),  # 删
    #get_engineer
    path('get', views.get_engineer, name='get_engineer'),  # 查
    #update_engineer
    path('update', views.update_engineer, name='update_engineer'),  # 改
    #getall
